 ...
 */
public class viewOwnEvents extends Fragment{
    ...
    public static android.support.v4.app.Fragment newInstance(Context context) {
        viewOwnEvents f = new viewOwnEvents();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(EventIndex==0)
                    Toast.makeText(getActivity(), "No more previous events.", Toast.LENGTH_LONG).show();
                else {
                    EventIndex--;
    ...
    public void displayEvents(int index){
        try {
            data[2] = "Time: "+eventsJson.getJSONObject(index).getString("time");
            data[3] = "Date: "+eventsJson.getJSONObject(index).getString("date");
...
//            data[2] = "Contact: "+eventsJson.getJSONObject(index).getString("contact");
    ...
    private void ViewEvents() {
        ...
        if(isSuccess==1) {
            try {data[2] = "Time: "+eventsJson.getJSONObject(0).getString("time");
                data[3] = "Date: "+eventsJson.getJSONObject(0).getString("date");
...
//                data[5] = "Contact: "+eventsJson.getJSONObject(0).getString("contact");
    ...
    class RetreiveData extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            jobj = clientServerInterface.makeHttpRequest("http://dontdumpdonate.byethost7.com/view_own_events.php",params);
